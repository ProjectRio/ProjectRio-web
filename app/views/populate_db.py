    ...
    if request.method == 'POST':
        ...
        if game == None:
            ...
            game = OngoingGame(
                ...
                away_roster_0_superstar = request.json["Away Roster 0 Superstar"],
                away_roster_0_fielding_pos = request.json["Away Roster 0 Fielding Position"],
                away_roster_1_char = request.json["Away Roster 1 CharID"],
                away_roster_1_superstar = request.json["Away Roster 1 Superstar"],
                away_roster_1_fielding_pos = request.json["Away Roster 1 Fielding Position"],
                away_roster_2_char = request.json["Away Roster 2 CharID"],
                away_roster_2_superstar = request.json["Away Roster 2 Superstar"],
                away_roster_2_fielding_pos = request.json["Away Roster 2 Fielding Position"],
                away_roster_3_char = request.json["Away Roster 3 CharID"],
                away_roster_3_superstar = request.json["Away Roster 3 Superstar"],
                away_roster_3_fielding_pos = request.json["Away Roster 3 Fielding Position"],
                away_roster_4_char = request.json["Away Roster 4 CharID"],
                away_roster_4_superstar = request.json["Away Roster 4 Superstar"],
                away_roster_4_fielding_pos = request.json["Away Roster 4 Fielding Position"],
                away_roster_5_char = request.json["Away Roster 5 CharID"],
                away_roster_5_superstar = request.json["Away Roster 5 Superstar"],
                away_roster_5_fielding_pos = request.json["Away Roster 5 Fielding Position"],
                away_roster_6_char = request.json["Away Roster 6 CharID"],
                away_roster_6_superstar = request.json["Away Roster 6 Superstar"],
                away_roster_6_fielding_pos = request.json["Away Roster 6 Fielding Position"],
                away_roster_7_char = request.json["Away Roster 7 CharID"],
                away_roster_7_superstar = request.json["Away Roster 7 Superstar"],
                away_roster_7_fielding_pos = request.json["Away Roster 7 Fielding Position"],
                away_roster_8_char = request.json["Away Roster 8 CharID"],
                away_roster_8_superstar = request.json["Away Roster 8 Superstar"],
                away_roster_8_fielding_pos = request.json["Away Roster 8 Fielding Position"],
                home_roster_0_char = request.json["Home Roster 0 CharID"],
                home_roster_0_superstar = request.json["Home Roster 0 Superstar"],
                home_roster_0_fielding_pos = request.json["Home Roster 0 Fielding Position"],
                home_roster_1_char = request.json["Home Roster 1 CharID"],
                home_roster_1_superstar = request.json["Home Roster 1 Superstar"],
                home_roster_1_fielding_pos = request.json["Home Roster 1 Fielding Position"],
                home_roster_2_char = request.json["Home Roster 2 CharID"],
                home_roster_2_superstar = request.json["Home Roster 2 Superstar"],
                home_roster_2_fielding_pos = request.json["Home Roster 2 Fielding Position"],
                home_roster_3_char = request.json["Home Roster 3 CharID"],
                home_roster_3_superstar = request.json["Home Roster 3 Superstar"],
                home_roster_3_fielding_pos = request.json["Home Roster 3 Fielding Position"],
                home_roster_4_char = request.json["Home Roster 4 CharID"],
                home_roster_4_superstar = request.json["Home Roster 4 Superstar"],
                home_roster_4_fielding_pos = request.json["Home Roster 4 Fielding Position"],
                home_roster_5_char = request.json["Home Roster 5 CharID"],
                home_roster_5_superstar = request.json["Home Roster 5 Superstar"],
                home_roster_5_fielding_pos = request.json["Home Roster 5 Fielding Position"],
                home_roster_6_char = request.json["Home Roster 6 CharID"],
                home_roster_6_superstar = request.json["Home Roster 6 Superstar"],
                home_roster_6_fielding_pos = request.json["Home Roster 6 Fielding Position"],
                home_roster_7_char = request.json["Home Roster 7 CharID"],
                home_roster_7_superstar = request.json["Home Roster 7 Superstar"],
                home_roster_7_fielding_pos = request.json["Home Roster 7 Fielding Position"],
                home_roster_8_char = request.json["Home Roster 8 CharID"],
                home_roster_8_superstar = request.json["Home Roster 8 Superstar"],
                home_roster_8_fielding_pos = request.json["Home Roster 8 Fielding Position"],
