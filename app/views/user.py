...
def request_password_change():
    ...
    html_content =  (
        f'''
            ...
            <a href={'https://project-rio-frontend.vercel.app/login/reset_password/' + user.active_url}>Reset Password</a>\n
            \n
            Happy hitting!\n
            Project Rio Web Team     
        '''
    ...
    text_content = (
        f'''
            ...
            We received a password reset request for your account. If you did not make this request, please ignore this email.\n
            Otherwise, follow this link to reset your password:\n
            https://project-rio-frontend.vercel.app/login/reset_password/{user.active_url}\n
            \n
            Happy hitting!\n
            Project Rio Web Team     
